  ...
  return (
    <div className="other-container">
      <div className="big-container">
        <h1 className="h1-height d-mobile">EXHIBITION</h1>
        <p className="p-height extra-padding-right-container font-size-20 color-brown">
          An exhibition is a public event at which pictures, sculptures, or
          other objects of interest are displayed, for example at a museum or
          art gallery.
        </p>
      </div>
